...
uint8_t DS18B20_Init(uint16_t DS18B20_RequestPeriod_ms);   // Настройка всего нужного; минимальный период 95 мс; возвращает 1, если на линии обнаружено хотя бы одно устройство, иначе 0
